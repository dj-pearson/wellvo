...
import net.dailyok.android.data.DailyOKDatabase
...
object AppModule {
    ...
    fun provideSharedPreferences(
        ...
        return context.getSharedPreferences("dailyok_prefs", Context.MODE_PRIVATE)
    }
    ...
    fun provideDatabase(
        ...
        val dbFile = context.getDatabasePath("dailyok.db")
        if (dbFile.exists()) {
        ...
        return Room.databaseBuilder(
            context,
            DailyOKDatabase::class.java,
            "dailyok_encrypted.db"
        )
    ...
    @Provides
    fun provideOfflineCheckInDao(database: DailyOKDatabase): OfflineCheckInDao {
    ...
    private fun migrateUnencryptedDb(context: Context) {
        val dbFile = context.getDatabasePath("dailyok.db")
        val walFile = context.getDatabasePath("dailyok.db-wal")
        val shmFile = context.getDatabasePath("dailyok.db-shm")
        dbFile.delete()
        walFile.delete()
        shmFile.delete()
    }
