...
class PdfExportService {
    ...
    companion object {
        ...
        private val DAILYOK_GREEN = Color.rgb(34, 197, 94)
        ...
        fun export(
            ...
            val fileName = "DailyOK_${receiverName.replace(" ", "_")}_${dateStr}.pdf"
        ...
        private fun drawHeader(canvas: Canvas, startY: Float, familyName: String, receiverName: String, days: Int): Float {
            ...
            canvas.drawText("Daily OK", MARGIN, y + 24f, titlePaint)
        ...
        private fun drawCheckInRow(canvas: Canvas, startY: Float, checkIn: CheckIn, isAlt: Boolean): Float {
            ...
            checkIn.responseType?.let { rt ->
                val rtStr = when (rt) {
                    net.dailyok.android.data.models.CheckInResponseType.Ok -> "OK"
                    net.dailyok.android.data.models.CheckInResponseType.NeedHelp -> "Need Help"
                    net.dailyok.android.data.models.CheckInResponseType.CallMe -> "Call Me"
                }
        ...
        private fun drawFooter(canvas: Canvas, pageNum: Int) {
            ...
            canvas.drawText("Generated by Daily OK", MARGIN, footerY, footerPaint)
