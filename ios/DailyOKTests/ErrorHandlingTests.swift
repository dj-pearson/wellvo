...
/// Tests for DailyOKError centralized error handling
final class ErrorHandlingTests: XCTestCase {
    ...
    func testUnknownErrorDescription() {
        ...
        let error = DailyOKError.unknown(underlying)
