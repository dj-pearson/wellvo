            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    SetupStepRow(
                        ...
                        description: "\(receiverName) will receive a text with a link to download Daily OK from the App Store."
                    )
                    ...
                    SetupStepRow(
                        ...
                        description: "Tap the link in the text to open the App Store and download Daily OK."
                    )
