...
/// Wellvo design tokens — colors, elevation, motion.
///
...
extension View {
    /// Apply a Wellvo elevation shadow consistent with the design system.
    func wellvoShadow(_ level: CGFloat, opacity: Double = 0.08) -> some View {
        shadow(
